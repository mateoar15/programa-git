    ...
    We need help to finish the new version of the program, that will
    run inside of GNU/Linux and Windows. It will be also improved.

    Read more at:

    http://freedfd.freaks-unidos.net

    You can also contact arhuaco@freaks-unidos.net if you want to know
    more about the FreeDFD project.
